...
const OnboardingIllustration = () => (
  <div className="relative w-full h-64">
    ...
    <svg viewBox="0 0 300 150" className="absolute inset-0 w-full h-full">
      <path
        d="M 20 130 Q 80 80, 150 90 T 280 20"
    ...
    <div className="max-w-md w-full space-y-8">
      ...
      <div className="text-center">
        ...
        <h2 className="text-2xl font-semibold text-muted-foreground mt-1">
          Your Personal Learning Navigator
        </h2>
        <p className="text-muted-foreground max-w-sm mx-auto italic pt-4">
          "What if learning felt as natural as asking a friend for help?"
        </p>
      </div>
...
const ProfileStep = ({
  ...
  onBack: () => void;
  onFinish: (values: OnboardingData) => void;
}) => {
    ...
    <div className="max-w-xl w-full">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This information helps us personalize your career suggestions.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <Input
                          placeholder="e.g., Technology, Art, Healthcare, FinTech"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
...
export function Onboarding({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4">
      ...
      {step === 2 && (
        <ProfileStep onBack={prevStep} onFinish={onOnboardingComplete} />
      )}
    </div>
  );
}
